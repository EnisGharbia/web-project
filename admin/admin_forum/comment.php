            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div id="load_tweets2"><?php  include('sidebar.php'); ?></div>
                        ...
                        <?php if($ttttt=="CHAMBRES"){ ?>
                            	<li ><a href="home.php"><img src="../images/chambre.png" width="40" height="40" />CHAMBRES</a></li>
                            
                            
                      <?php  }
                      
                        if($ttttt=="SERVICE"){ ?>
                            	<li ><a href="mac.php"><img src="../images/SERVICE.jpg" width="40" height="40" /> SERVICE</a></li>
                       ...
                       if($ttttt=="EVENT")
                        { ?>
                              <li ><a href="linux.php"><img src="../images/event.jpg" width="40" height="40" />EVENT</a></li>
                ...
                <td>&nbsp;</td>
                <td>
                <?php if($ttttt=="CHAMBRES"){ ?><a href="home.php" class="btn btn-default pull-right">Back</a> <?php } ?>
                 <?php if($ttttt=="SERVICE"){ ?><a href="mac.php" class="btn btn-default pull-right">Back</a> <?php } ?>
                  <?php if($ttttt=="EVENT"){ ?><a href="linux.php" class="btn btn-default pull-right">Back</a> <?php } ?>
